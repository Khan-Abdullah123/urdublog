            ...
            <dialog id="CreateModal" style=" border: 0.1px solid black;border-radius:2%; width:80vh;">
                    ...
                    <section>
                        <div class="dialog-header">
                            <h3 class="modal-title">
                                Blog
                                <i data-close class="fa fa-x"
                                    style="float:right;cursor:pointer;font-size:25px;padding-top:13px;"></i>
                            </h3>
                        </div>
                    </section>
                    <hr />
                ...
                <section>
                    <div class="dialog-footer">
                        <button data-close type="button" id="submitbtn" class="btn btn-lg btn-primary"
                            onclick="SaveBlog() " style="width: 100%">
                            Save
                        </button>
                    </div>
                </section>
