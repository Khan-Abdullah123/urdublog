                    ...
                    <div class="col-md-12">
                        <div class="blog-entry ftco-animate d-md-flex">
                            <a href="single.html" class="img img-2"
                                style="background-image: url({{url('public/andrea/images/image_1.jpg')}});"></a>
                            <div class="text text-2 pl-md-4" style="text-align: right">
                                <h3 class="mb-2"><a href="single.html">محبت کرنے والا دل حکمت ہے۔</a></h3>
                                <div class="meta-wrap">
                                    <p class="meta">
                                        <span>28 جون، 2019<i class="icon-calendar mr-2"></i></span>
